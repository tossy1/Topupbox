...
<li class="nav-item d-none d-sm-inline-block">
  ...
  <aside className="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" className="brand-link" style={{backgroundColor: '#343a40'}}><center>
        <img src="dist/img/Topupbox.png" alt="Topup-box Logo" width="180px;" height="50px;" /*img-square"*/ />
      </center></a>
    {/* Sidebar */}
              ...
              <div className="card-body">
                <div className="row">
                  ...
                  <div className="col-md-6 table-responsive">
                    <table className="table" style={{border: '1px solid silver'}}>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td> <input type="checkbox" name="boy" defaultValue="boy" />
                            Card
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td> <input type="checkbox" m nae="boy" defaultValue="boy" />
                            Send to me
                          </td>
                        </tr>
                        <tr>
                    ...
                    <table className="table table-hover" style={{border: '1px solid silver'}}>
                      <thead>
                        <tr>
                          <th>Transfer</th>
                          <th /> 
                    ...
                    <table className="table table-hover" style={{border: '1px solid silver'}}>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href>Download financial report</a></td>
                        </tr>
                      </tbody>
                    </table><center>
                      <div>
                        <p><i className="nav-icon fas fa-trash" /><a href>Delete test data</a></p>
                        <p><i className="nav-icon fas fa-trash" /><a href>Close this business</a></p>
                      </div></center>
                  </div>
                  <div className="col-md-3" />
                </div>
