    ...
    render() {
        return (<div>
            <div className="wrapper"> {/* Navbar */}
                <nav className="main-header navbar navbar-expand navbar-white navbar-light"> {/* Left navbar links */}
...
<li class="nav-item d-none d-sm-inline-block">
  <a href="#" class="nav-link">Contact</a>
                    ...
                    {/* Right navbar links */}
                    <ul className="navbar-nav ml-auto"> {/* Notifications Dropdown Menu */}
  ...
  <a class="nav-link" data-widget="control-sidebar" data-slide="true" href="#" role="button"><i
      class="fas fa-th-large"></i></a>
                ...
                <aside className="main-sidebar sidebar-dark-primary elevation-4"> {/* Brand Logo */}
                    ...
                    {/* Sidebar */}
                    <div className="sidebar"> {/* Sidebar user panel (optional) */}
                        ...
                        {/* Sidebar Menu */}
                        <nav className="mt-2">
                            <ul className="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false"> {/* Add icons to the links using the .nav-icon class
         with font-awesome or any other icon font library */}
                ...
                <div className="content-wrapper"> {/* Content Header (Page header) */}
                                            ...
                                            <div className="row"
                                                ...
                                                <div className="col-md-4" elevation-4>
                                                    <div className="card">
                                                        ...
                                                        <p>Learn how to build amazing<br/>
                                                            things with the Topup box API</p>
                                                ...
                                                <div className="col-md-4">
                                                    <div className="card">
                                                        ...
                                                        <p>Send us a message or chat<br/>
                                                            when someone is available</p>
                                                ...
                                                <div className="col-md-4">
                                                    <div className="card">
                                                        ...
                                                        <p>Learn how to integrate<br/>
                                                            Topup box with your business</p>
